...
<template>
  <main class="antialiased  text-slate-700 mx-2  ">
    <div class="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow-2xl">

      <div class="flex flex-row justify-between items-center border-b-2">
        <div class="my-5 px-3">
          <h1 class="text-3xl font-medium">Список дел</h1>
        </div>
        ...
        <div class="inline-flex space-x-2 items-center ">
          <a href="#"
            ...
            <span class="text-sm font-medium hidden md:block">Избранные</span>
          </a>
          <a href="#"
            ...
            <span class="text-sm hidden md:block">последние</span>
          </a>
        </div>

      </div>

      <p class="text-slate-500 my-3">Здравствуйте, вот ваши последние задачи</p>
      ...
      <p class="text-xs text-slate-500 text-center">Последнее обновление 12 минут назад</p>
    </div>
